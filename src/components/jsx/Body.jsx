...
function Body() {
  ...
  const { value, setValue, checkboxes, setCheckboxes ,login} = useContext(AppContext);
  ...
  useEffect(() => {
    const unsubscribe = Firebase.firestore()
      ...
      .onSnapshot((snapshot) => {
        ...
        console.log("navigation called",data,data.password);
  ...
  return <div>{isLoading ? <Loading /> : <Section />}</div>;
}
